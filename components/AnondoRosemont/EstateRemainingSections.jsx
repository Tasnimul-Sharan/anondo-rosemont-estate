  ...
  return (
    <section className="overflow-hidden bg-[#f8f3ec] py-16 text-[#241818] md:py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-5">
        <div className="grid gap-10 border-b border-secondary/15 pb-12 lg:grid-cols-[0.88fr_1.12fr] lg:items-end">
          <div>
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[0.32fr_1fr]">
          <aside className="hidden lg:block">
            <div className="sticky top-28 border-l border-secondary/20 pl-7">
              ...
              <Link
                href="/the-estate"
                className="group mt-8 inline-flex items-center gap-4 text-sm font-extrabold uppercase tracking-[0.14em] text-secondary"
              >
          ...
          <div className="grid gap-7">
            {remainingSections.map((section, index) => (
              <article
                key={section.title}
                className="group border border-secondary/15 bg-white p-7 shadow-xl shadow-secondary/10 transition duration-500 hover:-translate-y-1 md:p-10"
              >
