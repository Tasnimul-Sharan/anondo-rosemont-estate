      ...
      <div className="relative border-b border-secondary/15 py-16 md:py-24 lg:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-5">
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
            ...
            <div className="border border-white/15 bg-secondary p-7 text-white shadow-2xl shadow-secondary/20 lg:backdrop-blur-md">
          ...
          <div className="mx-auto grid max-w-[1200px] gap-12 px-5 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div className="relative">
              ...
              <div className="relative min-h-[560px] overflow-hidden bg-secondary shadow-2xl shadow-secondary/20">
                ...
                />
                <div className="absolute inset-x-0 -bottom-3 bg-secondary/82 px-7 pb-5 pt-4 text-white backdrop-blur-md">
            ...
            <article>
              ...
              {/* {chairman.signature && (
                <div className="mt-9 border-t border-secondary/15 pt-7">
                  <div className="relative overflow-hidden border-l-2 border-secondary bg-[#f8f3ec] px-6 py-5">
                    ...
                    <div className="mt-4 flex items-start gap-3">
                      <span className="mt-1 text-3xl font-serif leading-none text-secondary/35">
                        “
                      </span>
          ...
          <div className="mx-auto max-w-[1200px] px-5">
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-3">
              {philosophyItems.map((item, index) => (
                <article
                  key={item.title}
                  className="group border border-secondary/15 bg-white p-7 shadow-xl shadow-secondary/10 transition duration-500 hover:-translate-y-2 hover:bg-secondary hover:text-white"
                >
                  <p className="mb-7 text-xs font-extrabold uppercase tracking-[0.22em] text-secondary/45 transition group-hover:text-white/50">
        ...
        <div className="mx-auto max-w-[1200px] px-5">
          <div className="grid gap-10 lg:grid-cols-[0.42fr_1fr]">
            <aside className="hidden lg:block">
              <div className="sticky top-28 border-l border-secondary/20 pl-7">
                <p className="text-xs font-extrabold uppercase tracking-[0.26em] text-secondary/55">
                  Complete Narrative
                </p>
                <h2 className="mt-5 text-3xl font-semibold leading-tight text-secondary">
            ...
            <div className="grid gap-7">
              {remainingSections.map((section, index) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-semibold leading-tight text-secondary md:text-4xl">
                    {section.title}
                  </h3>
