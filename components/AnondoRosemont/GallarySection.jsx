  ...
  return (
    <section className="bg-[#f8f3ec] py-16 text-[#241818] md:py-24 lg:py-32">
      <div className="custom-container mx-auto">
        <div className="mb-10 grid gap-6 border-b border-secondary/15 pb-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          <div>
        ...
        {images.length > 0 ? (
            ...
            {images.map((image, index) => (
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-[#efe4d8]">
                  ...
                  <div className="absolute inset-0 bg-secondary/0 transition duration-500 group-hover:bg-secondary/10" />

                  <div className="absolute left-4 top-4 border border-white/30 bg-secondary/75 px-3 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white backdrop-blur-md">
                    {String(index + 1).padStart(2, "0")}
                  </div>
                </div>

                <div className="flex items-center justify-between gap-4 border-t border-secondary/10 p-5">
                  <div>
                    <p className="mb-2 text-[10px] font-extrabold uppercase tracking-[0.22em] text-secondary/45">
                      Rosemont Gallery
                    </p>
                    <h3 className="text-lg font-semibold leading-tight text-secondary">
                      {image.title}
                    </h3>
                  </div>

                  <span className="flex h-11 w-11 shrink-0 items-center justify-center border border-secondary/15 bg-[#f8f3ec] text-lg text-secondary transition duration-500 group-hover:bg-secondary group-hover:text-white">
                    <FiEye />
                  </span>
                </div>
              </button>
          ...
          <div className="border border-secondary/15 bg-white px-6 py-14 text-center text-[#6b5d57] shadow-xl shadow-secondary/10">
